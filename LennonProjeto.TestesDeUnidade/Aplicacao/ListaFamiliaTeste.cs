...
namespace Projeto.TestesDeUnidade.Aplicacao
{
    ...
    public class ListaFamiliaTeste
    {
        ...
        {            
            var familiaComRenda = new FamiliaBuilder().ComPontos(3).ComCpf("02512345688").Criar();            
            var familiaSemRenda = new FamiliaBuilder().ComPontos(5).ComRenda(0).Criar();
            ...
            Assert.True(familiasOrdenadasEsperadas.Last().Equals(familiasPontuadas.First()));
        }
    }
}
